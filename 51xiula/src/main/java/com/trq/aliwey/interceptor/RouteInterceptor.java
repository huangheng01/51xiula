...
public class RouteInterceptor implements Interceptor {
	...
	public void intercept(ActionInvocation ai) {
		...
		// 系统参数平台名称
		c.setAttr("SITE_NAME", ConfigPropKit.get("SITE_NAME", "随你花"));
		c.setAttr("COPYRIGHT", ConfigPropKit.get("copyright", "CopyRight © 2013-"+TimeKit.getYear()+" By aliwey"));
